...
//     _destinationLongitude = longitude;
//     _destinationController.text = fullAddress;
//     print('this is the destination lat$_destinationLatitude');
//     print('this is the destination long$_destinationLongitude');
...
//clear this before hosting
  ...
  void oncurrentlocationselected(
    ...
    print('this is the current lat$_currentLatitude');
    print('this is the current long$_currentLongitude');
    print('this is the current address:$_currentLocationController');
